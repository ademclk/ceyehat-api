...
namespace Ceyehat.Infrastructure.Migrations
{
    ...
    [Migration("20230214223109_CustomerMapping")]
            ...
            modelBuilder.Entity("Ceyehat.Domain.CustomerAggregate.Customer", b =>
                {
                    ...
                    b.OwnsMany("Ceyehat.Domain.PassengerAggregate.ValueObjects.PassengerId", "PassengerIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("CustomerPassengerIds", (string)null);
